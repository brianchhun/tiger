...
let string_of_error_msg = function
  | Arity_mismatch (s, t) ->
     "expected " ^ (string_of_int s) ^ " arguments but got " ^ (string_of_int t)
  | Array_type_mismatch ->
     "different array types"
  | Duplicate_type_declaration s ->
  ...
  | Unconstrained_nil ->
     "nil must be constrained to record"
  | Undefined_array s ->
     "undefined array " ^ s
  | Undefined_function s ->
     "undefined function " ^ s
  | Undefined_record s ->
     "undefined record " ^ s
  | Undefined_record_field s ->
     "undefined record field " ^ s
  | Undefined_type s ->
     "undefined type " ^ s
